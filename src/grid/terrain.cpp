...
std::unordered_map<TerrainType, const wchar_t *> Terrain::terrain_icons = {
    ...
    {TerrainType::Conifer_Forest, L"↑"},     {TerrainType::Ash_Forest, L"⌠"},
    {TerrainType::Pine_Forest, L"n"},        {TerrainType::Grassy_Plain, L"\""},
    {TerrainType::Frozen_Tundra, L"≡"},      {TerrainType::Barren_Plains, L"∩"},
    {TerrainType::Volcanic_Wasteland, L"▴"}, {TerrainType::Sandy_Desert, L"∩"},
