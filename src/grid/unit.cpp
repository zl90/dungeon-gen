    ...
    Unit::random_surnames_by_race = {
        {RaceType::Elf,
         {"Silverleaf", "Starfall", "Moonshadow", "Swiftwind", "Brightglow",
          "Forestwalker", "Leafwhisper", "Sunfire", "Dawnstar", "Valinar",
          "Vaelinor", "Falinar", "Aerlinor"}},
        {RaceType::Dwarf,
         {"Stonehammer", "Ironbeard", "Goldvein", "Steelaxe", "Deepdelver",
          "Oakenshield", "Mountainheart", "Stoutshield", "Honorforge",
          "Cliffbreaker"}},
        {RaceType::Human,
        ...
        {RaceType::Spirit,
         {"Etherealwind", "Shadeglow", "Soulshiver", "Phantomcry",
          ...
          "Echosong", "the Feared", "the Last One", "the Peaceful"}},
        {RaceType::Gelatinid,
